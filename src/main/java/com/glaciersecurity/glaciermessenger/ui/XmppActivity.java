...
// PIN - extend to use PIN everywherety
...
//				break;
	...
	public static class ConferenceInvite {
		...
		public boolean execute(XmppActivity activity) {
			...
			if (conversation.getMode() == Conversation.MODE_MULTI) {
				...
				return service.createAdhocConference(conversation.getAccount(), null, jids, false, activity.adhocCallback);
			}
		}
	}
	...
	// retry actions that their  permission might have been updated/granted and additional service is possible
	@Override
