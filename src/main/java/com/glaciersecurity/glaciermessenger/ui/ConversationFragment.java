	...
	protected boolean trustKeysIfNeeded(int requestCode, int attachmentChoice) {
		...
		if (hasUndecidedOwn || hasUndecidedContacts || hasPendingKeys || hasNoTrustedKeys || hasUnaccepted || downloadInProgress) {
			...
			if (requestCode == REQUEST_TRUST_KEYS_TEXT ||
					requestCode == REQUEST_TRUST_KEYS_MENU) {
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
		...
		if (conversation != null) {
			if (conversation.getMode() == Conversation.MODE_MULTI) {
				...
				menuConversationTimer.setVisible(false);
				...
				menuConversationTimer.setVisible(true);
...
//			case R.id.attach_location:
				...
				break;
			case R.id.action_conversation_timer:
