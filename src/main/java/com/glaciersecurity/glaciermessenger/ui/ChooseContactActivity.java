...
public class ChooseContactActivity extends AbstractSearchableListItemActivity implements MultiChoiceModeListener {
    ...
    public static final String EXTRA_PUBLIC_GROUP = "extra_public_group";
    ...
    private void submitSelection() {
        ...
        data.putExtra(EXTRA_PUBLIC_GROUP, request.getBooleanExtra(EXTRA_PUBLIC_GROUP, false));
        copy(request, data);
        setResult(RESULT_OK, data);
        finish();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        //Remove the top right barcode scanning feature
