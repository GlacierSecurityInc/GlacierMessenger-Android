...
public class PinCodeRoundView extends RelativeLayout {
    ...
    private void initializeView(AttributeSet attrs, int defStyleAttr) {
        if (attrs != null && !isInEditMode()) {
            ...
            if (mEmptyDotDrawableId == null) {
                mEmptyDotDrawableId = ResourcesCompat.getDrawable(getResources(), R.drawable.pin_code_round_empty, null);
            }
            mFullDotDrawableId = attributes.getDrawable(R.styleable.PinCodeView_lp_full_pin_dot);
            if (mFullDotDrawableId == null) {
                mFullDotDrawableId = ResourcesCompat.getDrawable(getResources(), R.drawable.pin_code_round_full, null);
            }
    ...
    public void setEmptyDotDrawable(int drawableId) {
        mEmptyDotDrawableId = ResourcesCompat.getDrawable(getResources(), drawableId, null);
    }
    ...
    public void setFullDotDrawable(int drawableId) {
        mFullDotDrawableId = ResourcesCompat.getDrawable(getResources(), drawableId, null);
    }
